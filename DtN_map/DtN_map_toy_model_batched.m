...
P = G;
sigma_fun =  @(x,y) 1.0 + interp2(xxSL,yySL, P, x,y );
...
StiffA = sparse(IdxIvec,IdxJvec, double(SigmaLord(:) + SigmaRord(:)),...
                (Nx+1)^2, (Nx+1)^2);
...
save(['test_DE/DtN_toy_',num2str(Nx),'.mat'], 'flux_d_total');
