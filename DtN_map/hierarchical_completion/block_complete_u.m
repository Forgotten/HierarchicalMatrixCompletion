function [block, mask, err] = block_complete_u(A, p, min_dim, r, tol)
...
if min_dim >= size(A,1)
    ...
    [block12, mask12, err12] = block_complete_o(A12,p ,min_dim, r, tol);
    [block21, mask21, err21] = block_complete_u(A21,pu,min_dim, r, tol);
